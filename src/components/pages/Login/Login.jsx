        ...
        <main className={LoginStyes.main}>
            <div className={LoginStyes.container}>
                ...
                <div className={LoginStyes.text}>
                    ...
                    <Link to='/register' className={`${LoginStyes.link} text text_type_main-default`}>Зарегистрироваться</Link>
                </div>
                <div className={LoginStyes.text}>
                    <p className="text text_type_main-default text_color_inactive">Забыли пароль?</p>
                    <Link to='/forgot-password' className={`${LoginStyes.link} text text_type_main-default`}>Восстановить пароль</Link>
                </div>
            </div>
